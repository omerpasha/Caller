#!/usr/bin/env python3
"""
Retell.ai Basit Test - Telefon Arama
"""
import asyncio
import os
import httpx
...
async def test_retell_call():
    """Retell.ai ile telefon araması testi"""
    try:
        ...
        print("🎤 Retell.ai telefon araması testi...")
...
async def main():
    print("🚀 Retell.ai Basit Test")
    print("=" * 40)
    
    success = await test_retell_call()
